...
sphere.position.set(gridMapHelper.getGlobalXPositionFromCoord(9),1.0,gridMapHelper.getGlobalZPositionFromCoord(5))

const boxGeometry = new THREE.BoxGeometry(2,2,2)
const boxMaterial = new THREE.MeshLambertMaterial({color: "rgb(0,255,0)"})
const box = new THREE.Mesh(boxGeometry,boxMaterial)
box.position.set(gridMapHelper.getGlobalXPositionFromCoord(7),1.0,gridMapHelper.getGlobalXPositionFromCoord(5))
