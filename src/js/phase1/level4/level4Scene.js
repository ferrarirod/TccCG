...
sphere1.position.set(gridMapHelper.getGlobalXPositionFromCoord(6),1.0,gridMapHelper.getGlobalZPositionFromCoord(2))
sphere2.position.set(gridMapHelper.getGlobalXPositionFromCoord(7),1.0,gridMapHelper.getGlobalZPositionFromCoord(8))
...
function contemEsfera()
{
    ...
    if(checkCollision(actor,sphere1)||checkCollision(actor,sphere2))
    {
        printOnConsole("Uma esfera foi encontrada.")
        return true
    }
    else
    {
...
function removeEsfera()
{
    ...
    if(checkCollision(actor,sphere1))
    {
        sphere1.visible = false
        printOnConsole("Esfera removida.")
    }
    else if(checkCollision(actor,sphere2))
    {
...
{
    if(!sphere1.visible && !sphere2.visible)
    {
        return true
    }
    else
